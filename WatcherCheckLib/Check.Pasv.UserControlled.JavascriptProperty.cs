...
namespace CasabaSecurity.Web.Watcher.Checks
{
    ...
    public class CheckPasvUserControlledJavascriptProperty : WatcherCheck
    {
        ...
        {
            return "User Controlled - Find user controllable Javascript References.";
        }
        ...
        {
            String name = "User Controllable Javascript Reference";
            String text =
        ...
        private void CheckUserControllableJavascriptReference(NameValueCollection parms, String att, String context)
        {
            String pro = null;
            String dom = null;
            String tok = null;
        ...
        private void CheckUserControllableJavascriptReferenceProperty(NameValueCollection parms, String bod, String property)
        {
            ...
            foreach (Match m in Regex.Matches(bod, "\\w+?\\." + property + "\\s*?=\\s*?(\'|\").*?(\'|\")", RegexOptions.Singleline))
            {
                ...
                if (a.Success)
                    CheckUserControllableJavascriptReference(parms, Utility.StripQuotes(a.ToString()), m.ToString());
            }
        }
