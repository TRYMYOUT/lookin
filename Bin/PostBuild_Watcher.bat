...
copy /y %1 %2
if %ERRORLEVEL% NEQ 0 (
	echo Error: PostBuild: Cannot copy latest Watcher build to Fiddler scripts directory.  Make sure Fiddler is not running prior to copying.  Result: %ERRORLEVEL%
)
