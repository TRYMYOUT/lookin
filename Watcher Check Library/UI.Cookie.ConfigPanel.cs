...
namespace CasabaSecurity.Web.Watcher.Checks
{
    public partial class CookieCheckConfigPanel : UserControl
    {
        ...
        private void addbutton_Click(object sender, EventArgs e)
        {
            ...
            WatcherEngine.Configuration.SetConfigItem(watchercheck, "CookieList", (String)String.Join(",", tempstring.ToArray()));
        ...
        private void deletebutton_Click(object sender, EventArgs e)
        {
            ...
            WatcherEngine.Configuration.SetConfigItem(watchercheck, "CookieList", String.Join(",", tempstring.ToArray()));
            watchercheck.UpdateWordList();
        }
