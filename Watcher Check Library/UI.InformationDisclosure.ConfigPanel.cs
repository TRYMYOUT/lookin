    ...
    public partial class StringCheckConfigPanel : UserControl
    {
        ...
        public void Init(String[] defaultstrings, String boxtitle, String entrytitle)
        {
            ...
            if (defaultstrings != null)
            {
                ...
                configstring = WatcherEngine.Configuration.GetConfigItem(watchercheck, "stringcheckList", (String)String.Join(",", defaultstrings));
            }
            else
            {
                configstring = WatcherEngine.Configuration.GetConfigItem(watchercheck, "stringcheckList");
            }
        ...
        private void deletebutton_Click(object sender, EventArgs e)
        {
            ...
            WatcherEngine.Configuration.SetConfigItem(watchercheck, "stringcheckList", String.Join(",", tempstring.ToArray()));
            watchercheck.UpdateWordList();
        }
    }
}
